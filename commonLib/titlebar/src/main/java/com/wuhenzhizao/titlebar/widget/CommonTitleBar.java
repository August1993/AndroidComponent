...
public class CommonTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private int leftTextColor = Color.BLACK;                          // 左边TextView颜色
    private float leftTextSize = 16;                         // 左边TextView文字大小
    ...
    private int rightTextColor = Color.BLACK;                         // 右边TextView颜色
    private float rightTextSize = 16;                        // 右边TextView文字大小
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            leftTextSize = array.getDimension(R.styleable.CommonTitleBar_leftTextSize, 16);
